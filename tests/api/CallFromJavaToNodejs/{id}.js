...
/**
 * Test for /api/CallFromJavaToNodejs/{id}
 */
Test('/api/CallFromJavaToNodejs/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test CallFromJavaToNodejs_Get get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/api/CallFromJavaToNodejs/{id}']['get']['responses']['200']['schema']);
