...
/**
 * Test for /api/CallFromWebsiteToNodeJs/{id}
 */
Test('/api/CallFromWebsiteToNodeJs/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test CallFromWebsiteToNodeJs_GetById get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/api/CallFromWebsiteToNodeJs/{id}']['get']['responses']['200']['schema']);
