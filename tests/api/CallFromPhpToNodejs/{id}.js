...
/**
 * Test for /api/CallFromPhpToNodejs/{id}
 */
Test('/api/CallFromPhpToNodejs/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test CallFromPhpToNodejs_Get get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/api/CallFromPhpToNodejs/{id}']['get']['responses']['200']['schema']);
