...
/**
 * Test for /api/CallFromCSToNodejsTo/{id}
 */
Test('/api/CallFromCSToNodejsTo/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test CallFromCSToNodejsTo_Get get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/api/CallFromCSToNodejsTo/{id}']['get']['responses']['200']['schema']);
