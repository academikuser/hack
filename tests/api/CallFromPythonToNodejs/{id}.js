...
/**
 * Test for /api/CallFromPythonToNodejs/{id}
 */
Test('/api/CallFromPythonToNodejs/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test CallFromPythonToNodejs_Get get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/api/CallFromPythonToNodejs/{id}']['get']['responses']['200']['schema']);
